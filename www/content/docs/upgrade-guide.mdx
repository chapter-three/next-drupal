...
2. Edit the Next.js user and assign all roles that can be used as a scope. The granted roles will be filtered based on roles assigned to the current user.
