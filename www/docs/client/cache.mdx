...
You can provide your own cache implementation using the [`cache`](/docs/client/configuration#cache) option.

### Example

Here's an example on how you can Redis to cache resources.
