...
import { NextDrupalFetch } from "../../src"
...
describe("baseUrl parameter", () => {
  ...
  test("throws error given an invalid baseUrl", () => {
    // @ts-ignore
    expect(() => new NextDrupalFetch()).toThrow(
  ...
  test("returns a NextDrupalFetch", () => {
    expect(new NextDrupalFetch(BASE_URL)).toBeInstanceOf(NextDrupalFetch)
  })
})
...
describe("options parameter", () => {
  ...
  describe("debug", () => {
    ...
    test("turns on debug mode", () => {
      ...
      new NextDrupalFetch(BASE_URL, { debug: true })
  ...
  describe("fetcher", () => {
    ...
    test("sets up a custom fetcher", () => {
      const customFetcher: NextDrupalFetch["fetcher"] = async () => {
        //
      }
      const drupal = new NextDrupalFetch(BASE_URL, {
